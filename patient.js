      ...
      el2.innerHTML =
        '<div class="insight-box insight-box--amber">' +
          ...
          '<div style="margin-top:12px;text-align:right">' +
            '<button onclick="showFullInsight(\'' + encodeURIComponent(ins.patient_comment) + '\')" style="background:none;border:none;color:var(--emerald);font-size:12px;cursor:pointer;text-decoration:underline">'+t('patient.seeDetail')+'</button>' +
          '</div>' +
        '</div>';
    });
  });
