    ...
    fetchInsightsByCategory(patientId, category).then(async function(ins) {
      ...
      if (clinEl) {
        if (!ins) {
          ...
          var parts = [];
          if (ins.interpretation) parts.push('<div style="margin-bottom:14px"><div style="font-size:11px;font-weight:600;letter-spacing:1px;text-transform:uppercase;color:var(--ink4);margin-bottom:6px">' + t('clinic.interpretation') + '</div><div style="font-size:13px;color:var(--ink2);line-height:1.9;white-space:pre-wrap">' + ins.interpretation + '</div></div>');
          if (ins.recommendation) parts.push('<div><div style="font-size:11px;font-weight:600;letter-spacing:1px;text-transform:uppercase;color:var(--ink4);margin-bottom:6px">' + t('clinic.intervention') + '</div><div style="font-size:13px;color:var(--ink2);line-height:1.9;white-space:pre-wrap">' + ins.recommendation + '</div></div>');
          clinEl.innerHTML =
